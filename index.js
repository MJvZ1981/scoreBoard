...
function difineBorderColor() {
  homeScore === guestsScore
    ? (homeEl.style.borderColor = "darkblue") &&
      (guestsEl.style.borderColor = "darkblue")
    : homeScore > guestsScore
    ? (homeEl.style.borderColor = "red") &&
      (guestsEl.style.borderColor = "blue")
    : (guestsEl.style.borderColor = "red") &&
      (homeEl.style.borderColor = "darkblue");
}
...
function handleScore(team, value) {
  shotClock();
  team === "home"
    ? (homeScore += value) && (homeEl.textContent = homeScore)
